...
- giving clear technical feedback without personal attacks
- respecting consent, privacy, and safety in voice/audio discussions
- crediting datasets, papers, tools, and contributors properly
...
Technical research is welcome. Misuse guidance is not.

---

## Enforcement Responsibilities

Community leaders are responsible for clarifying and enforcing standards of acceptable behavior. They may remove, edit, or reject comments, commits, code, issues, pull requests, and other contributions that are not aligned with this Code of Conduct.

Community leaders may also temporarily or permanently ban contributors for behavior that they deem inappropriate, threatening, offensive, harmful, or unsafe.
...
- community chat or forum spaces
- public communication when representing the project

It also applies when someone is officially representing `aarambh-voice-studio` in public spaces.
...
**Consequence:** A private written warning from community leaders, explaining the violation and why it was inappropriate.

### 2. Warning

**Community Impact:** A violation through a single incident or series of actions.

**Consequence:** A warning with consequences for continued behavior. The contributor may be asked to avoid interaction with affected people for a specified period.

### 3. Temporary Ban

**Community Impact:** A serious violation of community standards, including sustained inappropriate behavior or unsafe misuse guidance.
